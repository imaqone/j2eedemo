...
<form action="RegisterServlet"method="post">
    ...
    confirm password:<input type="password"name="con_password"value="<%=request.getAttribute("con_password")!=null?request.getAttribute("con_password"):""%>"/>
    <%=request.getAttribute("msg_con_password")!=null?request.getAttribute("msg_con_password"):""%><br/>
    <input type="sumit"value="Register"/>
</form>
<a herp="login.jsp">Return back to login page</a>
